...
export const CartItem: React.FC = () => {
  ...
  return (
    <div className='flex h-auto flex-col w-full md:w-5/6'>
      <h1 className='text-start text-3xl font-bold m-4 underline underline-offset-3 decoration-8 decoration-green-400 text-gray-700'>Products:</h1>
